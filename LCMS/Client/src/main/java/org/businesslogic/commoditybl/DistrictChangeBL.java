...
public class DistrictChangeBL implements DistrictChangeBLService {
	...
	public void change(String from, String to,int index) throws RemoteException {
		...
		myDate newdate= new myDate(Integer.parseInt(vo.getyear()),Integer.parseInt(vo.getmonth()),Integer.parseInt(vo.getday()));
		CommodityVO newvo=new CommodityVO(vo.getGoodsNum(),newdate,vo.getplace(),vo.getLocation(),to,vo.getcity());
		changeDistrict(vo);
	}
